                ...
                <div class="border-2 p-5 border-gray-300 dark:border-gray-600 rounded-lg">
                    <form method="post">
                        <div class="mt-3">
                            ...
                            <input class="text-sky-600 w-full my-5 px-5 py-3 border-2 border-gray-300 focus:ring-4 focus:ring-gray-300 dark:bg-transparent focus:outline-none dark:focus:ring-4 dark:focus:ring-gray-700 rounded-lg transition-all ease-linear duration-300" type="text" name="category_name" id="category-name" value="<?php if (isset($category_edit)) echo $category_edit['name'] ?>">
                        ...
                        <div class="mt-3 flex justify-between items-center">
                            <button name="add_category_btn" class="mt-5 transition-all duration-300 ease-linear px-5 py-3 border-2 bg-sky-500 text-white hover:bg-white dark:hover:bg-gray-600 dark:hover:text-white border-sky-500 dark:border-sky-500 dark:text-white hover:text-sky-500 rounded-lg">Upload
                                Category</button>
