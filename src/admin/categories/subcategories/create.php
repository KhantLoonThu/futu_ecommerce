...
if (isset($_POST['add_subcategory_btn'])) {
    ...
    if (!$error) {
        ...
        if ($alreadyExisted['total'] == 0) {
            $status = $subcategory_controller->putSubcategory($subcategory_name, $category_name);
            $subcategory_name = "";
            header('location:./index.php?sub_create_success=true');
            exit;
        } else {
            header('location:./index.php?sub_create_success=false');
            exit;
        }
    }
}
...
<main class="relative">
    ...
    <section class="bg-gray-100 h-screen dark:bg-gray-900 dark:text-white main-part lg:w-5/6 md:w-5/6 sm:w-full ms-auto transition-all ease-linear duration-300">
        ...
        <div class="my-[50px] max-w-screen-lg mx-auto flex justify-center items-center h-[70vh]">
            <div>
                <h2 class="text-[32px] font[500] mb-[30px]">Add New Subcategory</h2>
                <div class="border-2 p-5 border-gray-300 dark:border-gray-600 rounded-lg">
                    <form method="post">
                        ...
                        <div class="mt-3">
                            ...
                            <input class="text-sky-600 w-full my-5 px-5 py-3 border-2 border-gray-300 focus:ring-4 focus:ring-gray-300 dark:bg-transparent focus:outline-none dark:focus:ring-4 dark:focus:ring-gray-700 rounded-lg transition-all ease-linear duration-300" type="text" name="subcategory_name" id="subcategory-name" value="<?php if (isset($subcategory_name)) echo $subcategory_name ?>">
                            <span class="text-rose-600">
                                <?php
