...
<main class="relative">
    ...
    <section class="bg-gray-100 h-screen dark:bg-gray-900 dark:text-white main-part lg:w-5/6 md:w-5/6 sm:w-full ms-auto transition-all ease-linear duration-300">
        <!-- navbar -->
        <?php include_once __DIR__ . '/../../../layouts/admin/navbar.php'; ?>

        <!-- main category -->
        <div class="my-[50px] max-w-screen-lg mx-auto flex justify-center items-center h-[70vh]">
            <div>
                ...
                <div class="border-2 p-5 border-gray-300 dark:border-gray-600 rounded-lg">
                    <form method="post">
                        <div class="mt-3">
                            ...
                            <select class=" text-sky-600 w-full my-5 px-5 py-3 border-2 border-gray-300
                                ...
                                <?php foreach ($categories as $category) : ?>
                                    <option value="<?= $category['id'] ?>" <?php if ($current_subcategory['category_id'] == $category['id']) echo 'selected'; ?>>
                                        <?= $category['name'] ?>
                                    </option>
                                <?php endforeach ?>
                            </select>
                        ...
                        <div class="mt-3">
                            ...
                            <input class="text-sky-600 w-full my-5 px-5 py-3 border-2 border-gray-300 focus:ring-4 focus:ring-gray-300 dark:bg-transparent focus:outline-none dark:focus:ring-4 dark:focus:ring-gray-700 rounded-lg transition-all ease-linear duration-300" type="text" name="subcategory_name" id="subcategory-name" value="<?php if (isset($current_subcategory)) echo $current_subcategory['name'] ?>">
                            <span class="text-rose-600">
                                <?php
                        ...
                        <div class="mt-3 flex justify-between items-center">
                            <button name="add_subcategory_btn" class="mt-5 transition-all duration-300 ease-linear px-5 py-3 border-2 bg-sky-500 text-white hover:bg-white dark:hover:bg-gray-600 dark:hover:text-white border-sky-500 dark:border-sky-500 dark:text-white hover:text-sky-500 rounded-lg">Update
                                Subategory</button>
                            <a href="<?= BASE_URL; ?>/admin/categories/subcategories/index.php" class="rounded-lg mt-5 px-5 py-3 border-2 border-gray-400 dark:border-gray-300">Back to
                                Subcategory</a>
                        </div>
                    </form>
                </div>
