...
<nav class="sticky top-0 right-0 w-full bg-white dark:bg-gray-900 transition-all ease-linear duration-300 z-0 flex justify-between items-center py-2 px-8  border-b border-b-gray-300 dark:border-b-gray-600 shadow-lg">
    <div>
