...
<aside
    class="aside-sidebar border-e border-e-gray-600 hidden lg:block md:block sm:block sm:absolute sm:-left-[50%] sm:top-0 lg:w-1/6 md:w-1/6 sm:w-1/2 h-screen bg-gray-900 text-white lg:fixed lg:top-0 lg:left-0 md:fixed md:top-0 md:left-0">
    <!-- brand logo -->
    <div class="flex justify-between items-center border-b border-b-gray-700">
        <a href="<?= BASE_URL; ?>/admin/index.php" class="logo-brand flex justify-start items-center pl-8 pt-3 pb-3">
            <!-- duck logo -->
            <svg class="w-12 h-12 hidden lg:block md:hidden sm:block" xmlns="http://www.w3.org/2000/svg"
        ...
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
            class="w-6 h-6 text-white text-end ms-auto me-5 hidden sm:block x-toggle-sidebar lg:hidden md:hidden cursor-pointer">
    ...
    <ul class="sidebar-tabs mt-2 flex flex-col w-full">
        ...
        <li
            class="tabs dashboard-tab hover:bg-gray-700 w-full active py-4 border-l-4 border-transparent hover:border-indigo-500 hover:text-indigo-500">
            <a href="<?= BASE_URL; ?>/admin/index.php" class="flex justify-start items-center pl-8">
                <svg class="w-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
        ...
        <li
            class="category-toggle tabs admin-console-tabs flex justify-between items-center px-8 hover:bg-gray-700 cursor-pointer w-full py-4 border-l-4 border-transparent hover:border-indigo-500 hover:text-indigo-500">
            ...
            <div>
                <svg class="toggle-btn  w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
        ...
        <ul class="hidden inner-category flex-col items-center transition-all ease-linear duration-300">
            <li
                class="inner-tabs flex items-center ps-14 pe-8 hover:bg-gray-700 cursor-pointer w-full py-4 border-l-4 border-transparent hover:border-indigo-500 hover:text-indigo-500">
        ...
        <li
            class="product-toggle tabs admin-console-tabs flex justify-between items-center px-8 hover:bg-gray-700 cursor-pointer w-full py-4 border-l-4 border-transparent hover:border-indigo-500 hover:text-indigo-500">
            <div class="flex items-center">
                <svg class="w-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <li
            class="user-toggle tabs admin-console-tabs flex justify-between items-center px-8 hover:bg-gray-700 cursor-pointer w-full py-4 border-l-4 border-transparent hover:border-indigo-500 hover:text-indigo-500">
            <div class="flex items-center">
                <svg class="w-7" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
