...
<template>
  ...
  >
    <!-- SIDEBAR HEADER -->
    <div
      class="flex items-center justify-between xl:justify-center lg:justify-center gap-2 px-6 py-5.5 lg:py-6.5"
    >
      <router-link to="/" class="flex items-center justify-between">
        <svg
          class="w-10 h-10 hidden lg:block md:hidden sm:hidden"
          xmlns="http://www.w3.org/2000/svg"
        ...
        <span
          class="text-3xl text-slate-300 font-semibold leading-9 pl-2 hidden lg:block md:hidden sm:hidden"
          >FUTU</span
        >
      </router-link>
