...
if (isset($_POST['add_product_btn'])) {
    ...
    if (!$error) {
        ...
        if ($alreadyExist['total'] == 0) {
            $product_controller->putProduct($product_name, $product_price, $fname, $product_description, $product_quantity, $category_id, $subcategory_id);
            $product_name = '';
            $product_price = '';
            $product_quantity = '';
            header('location: ./index.php?create_product_success=true');
            exit;
        } else {
            header('location: ./index.php?create_product_success=false');
            exit;
        }
    } else {
        ...
        <div class="my-[50px] max-w-screen-lg mx-auto">
            <div>
                <form method="post" enctype="multipart/form-data">
                    <div class="create-product-firstpage border-2 p-5 border-gray-300 dark:border-gray-600 rounded-lg">
                        ...
                        <div class="mt-3">
                            ...
                            <select class=" text-sky-600 w-full my-5 px-5 py-3 border-2 border-gray-300
                                ...
                                duration-300 create-product-category-name" name="category_id" id="category-name">
                        ...
                        <div class="hidden mt-3">
                            ...
                            <select class=" text-sky-600 w-full my-5 px-5 py-3 border-2 border-gray-300
                                focus:ring-4 focus:ring-gray-300 dark:bg-transparent focus:outline-none
                                dark:focus:ring-4 dark:focus:ring-gray-700 rounded-lg transition-all ease-linear
                                duration-300 create-product-subcategory-name" name="subcategory_id" id="category-name">
                            </select>
                            <span class="text-rose-600">
                                <?php
                    ...
                    <div
                        class="create-product-secondpage hidden border-2 p-5 border-gray-300 dark:border-gray-600 rounded-lg">
                        ...
                        <div class="grid grid-cols-2 gap-[50px]">
                            <div>
                                ...
                                duration-300" type="number" name="product_price" id="product-price"
                                        value="<?php if (isset($product_price)) $product_price ?>">
                                    <span class="text-rose-600">
                                        <?php
                            ...
                            <div>
                                ...
                                duration-300" name="product_description" id="product-description"
                                        value="<?php if (isset($product_description)) echo $product_description ?>"></textarea>
                                </div>
                                <div class="mt-3">
                        ...
                        <div class="mt-3 flex justify-end items-center">
                            ...
                            <button
                                class="ms-5 rounded-lg mt-5 px-5 py-3 border-2 border-gray-400 dark:border-gray-300 back-to-first-page">Back
                                to
