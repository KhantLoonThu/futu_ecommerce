    ...
    <section
        ...
        <div class="w-full my-[50px] h-auto">
            <div class="lg:max-w-screen-lg sm:max-w-screen-sm mx-auto">
                ...
                <div class="mt-10">
                    <a href="<?= BASE_URL ?>/admin/categories/categories/create.php"
                        ...
                        <tbody>
                            ...
                            <tr class=" divide-x-2 divide-gray-300 dark:divide-gray-500 border-b-2 border-b-gray-300 dark:border-b-gray-500
                                ...
                                <td class="py-3 text-center">
                                    <a href="<?= BASE_URL ?>/admin/categories/categories/edit.php?id=<?= $category['id'] ?>"
                                    ...
                                    <a href="<?= BASE_URL ?>/admin/categories/categories/delete.php?id=<?= $category['id'] ?>"
                                        class="px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg inline-flex items-center">
                                        <span class="me-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                                <path stroke-linecap="round" stroke-linejoin="round"
