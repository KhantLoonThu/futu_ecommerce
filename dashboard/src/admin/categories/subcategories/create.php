                    ...
                    <form method="post">
                        ...
                        <div class="mt-3">
                            ...
                            <input
                                ...
                                value="<?php if (isset($subcategory_name)) echo $subcategory_name ?>">
                            <span class="text-rose-600">
                                <?php
                        ...
                        <div class="mt-3 flex justify-between items-center">
                            <button name="add_subcategory_btn"
                                class="mt-5 transition-all duration-300 ease-linear px-5 py-3 border-2 bg-sky-500 text-white hover:bg-white dark:hover:bg-gray-600 dark:hover:text-white border-sky-500 dark:border-sky-500 dark:text-white hover:text-sky-500 rounded-lg">Add
                                Subategory</button>
