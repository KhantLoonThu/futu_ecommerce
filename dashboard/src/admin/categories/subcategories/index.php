...
<main class="relative">
    ...
    <section
        ...
        <!-- main category -->
        <div class="w-full h-auto my-[50px]">
            <div class="lg:max-w-screen-lg sm:max-w-screen-sm mx-auto">
                ...
                <div class="mt-10">
                    <a href="<?= BASE_URL ?>/admin/categories/subcategories/create.php"
                ...
                <div class="mt-10">
                    <table id="myTable" class="w-full border-2 dark:text-white border-gray-300 dark:border-gray-500">
                        ...
                        <tbody>
                            ...
                            <?php if ($subcategory['category_id'] == $category['id'] && !$subcategory['archive'] == 1 && !$category['archive'] == 1) : ?>
                            ...
                            <tr class=" divide-x-2 divide-gray-300 dark:divide-gray-500 border-b-2 border-b-gray-300 dark:border-b-gray-500
                                ...
                                <td class="py-3 text-center">
                                    <a href="<?= BASE_URL ?>/admin/categories/subcategories/edit.php?id=<?= $subcategory['id'] ?>&cate_id=<?= $subcategory['category_id'] ?>"
                                    ...
                                    <a href="<?= BASE_URL ?>/admin/categories/subcategories/delete.php?id=<?= $subcategory['id'] ?>&cate_id=<?= $subcategory['parent_category_id'] ?>"
