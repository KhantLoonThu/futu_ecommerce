<template>
  <nav class="py-4 shadow-lg sticky top-0 left-0 z-50">
    <div
      class="w-full px-[5%] lg:px-[8%] md:px-[5%] flex justify-between items-center"
    >
      <!-- navbar brand -->
      <router-link
        :to="{ name: 'Home' }"
        class="navbar-brand flex items-center"
      >
        <!-- duck logo -->
        <div>
          <svg
            class="w-12 h-12 hidden lg:block md:hidden sm:block me-5"
          ...
          >
            ...
            <g>
              <g>
                ...
                <path
                  fill="url(#grad1)"
                  d="M16.111,23.435c-3.225,0-3.225,5,0,5S19.336,23.435,16.111,23.435z"
                ></path>
                <path
                  fill="url(#grad1)"
                  d="M47.889,23.435c-3.225,0-3.225,5,0,5S51.113,23.435,47.889,23.435z"
                ></path>
              </g>
            </g>
          </svg>
        ...
        <div>
          <img :src="logo" class="w-[100px]" alt="Logo" />
        </div>
      </router-link>
      <ul class="flex items-center">
        <li class="px-10 text-[20px] font-[500]">
  ...
  computed: {
    ...
    logo(): string {
      return this.$store.state.theme === "dark"
        ? "/images/futu-high-resolution-logo-white-transparent.png"
        : "/images/futu-high-resolution-logo-black-transparent.png";
    },
  },
});
</script>
